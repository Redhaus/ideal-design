export const primaryReading_EN = {
    unitOne: {
        primary: {
            category: {
                beginner: [{
                ...
                },
                {
                    ...
                    description: "When it was published in 1997, Tales from Ovid was immediately recognized as a classic in its own right, as the best rendering of Ovid in generations, and as a major book in Ted Hughes's oeuvre. The Metamorphoses of Ovid stands with the works of Homer, Virgil, Dante, and Milton as a classic of world poetry; Hughes translated twenty-four of its stories with great power and directness. The result is the liveliest twentieth-century version of the classic, at once a delight for the Latinist and an appealing introduction to Ovid for the general reader.",
