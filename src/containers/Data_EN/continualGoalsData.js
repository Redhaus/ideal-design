export const continualGoalsData_EN = [{
    goal: 'Reading',
    ...
    skills: ['note taking', 'annotating', 'data and graphs', 'technical writing','visualization', 'vocalization']
    },
    {
    goal: 'Writing',
    ...
    skills: ['MLA format', 'thesis statements','body paragraphs','topic sentences','organization','internal transitions','transitional phrases','boundary statements','effective titles','academic language','academic voice','informal voice','formal voice','plagiarism warning','modifying quotations','integrating quotations','citing quotations','works cited page']
    },
    {
    goal: 'Language',
    ...
    skills: ['idioms/colloquialisms','proper use of tense','dictionary usage','etymological study','grammar study','evaluating sources','internet research','library research']
    },
    {
...
export const continualRolloverData_EN = {
